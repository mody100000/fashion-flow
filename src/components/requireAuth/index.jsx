...
const requireAuth = (Component) => {
    ...
    return (
        <>
        {loading && <div className="h-screen bg-zinc-800 flex justify-center items-center"><Spinner size={50}/></div>} {/* TODO: show skeleton loading instead */}
        {authenticated && <Component {...authUser}/>}
        </>
    )
} 
